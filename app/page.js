    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="px-10 py-24 text-center max-w-6xl mx-auto">
        ...
        <div className="mt-10 flex justify-center gap-4">
          <button className="px-8 py-4 rounded-full bg-white text-black font-semibold text-lg">
            Get Early Access
          </button>

          <button className="px-8 py-4 rounded-full border border-white/20 text-lg">
            Learn More
          </button>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-10 pb-24 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-10">
          ...
          <div className="p-8 rounded-3xl border border-white bg-white text-black">
